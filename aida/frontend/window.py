...
class AIDAWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.app_subtitle = QLabel("SYSTEMS DIAGNOSTIC CORE • ARTIFICER ENABLED")
        ...
        self.dashboard.artificer_requested.connect(self.artificer_requested.emit)
    ...
    def _build_layout(self) -> None:
        ...
        self.workspace_splitter.setSizes([280, 900])
